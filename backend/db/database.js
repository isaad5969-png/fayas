...
const ALL_UNIVERSITIES = [
  ...
  ['UM5',        'Université Mohammed V',                    'Rabat',       '#7C3AED', 85000,  'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Mohammed_V_University_Logo.png/250px-Mohammed_V_University_Logo.png'],
  ['UH2C',       'Université Hassan II',                     'Casablanca',  '#DC2626', 120000, 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/UH2-logo.png/250px-UH2-logo.png'],
  ['UCA',        'Université Cadi Ayyad',                    'Marrakech',   '#D97706', 95000,  'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Universite_Cadi_Ayyad.png/250px-Universite_Cadi_Ayyad.png'],
  ['USMBA',      'Université Sidi Mohammed Ben Abdellah',    'Fès',         '#6D28D9', 80000,  'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/University_SIDI_MOHAMMED_BEN_ABBEDELLAH.jpg/250px-University_SIDI_MOHAMMED_BEN_ABBEDELLAH.jpg'],
  ['UIT',        'Université Ibn Tofail',                    'Kénitra',     '#059669', 45000,  'https://upload.wikimedia.org/wikipedia/commons/1/18/%D8%AC%D8%A7%D9%85%D8%B9%D8%A9_%D8%A5%D8%A8%D9%86_%D8%B7%D9%81%D9%8A%D9%84.png'],
  ['UIZ',        'Université Ibn Zohr',                      'Agadir',      '#0284C7', 60000,  'https://upload.wikimedia.org/wikipedia/commons/b/b0/Logo-UIZ.jpg'],
  ['UAE',        'Université Abdelmalek Essaâdi',            'Tétouan',     '#BE185D', 55000,  'https://upload.wikimedia.org/wikipedia/en/3/35/Abdelmalek_Essaadi_University.png'],
  ['UMI',        'Université Moulay Ismail',                 'Meknès',      '#B45309', 40000,  'https://upload.wikimedia.org/wikipedia/commons/f/f7/Logo-umi.png'],
  ['UH1',        'Université Hassan 1er',                    'Settat',      '#065F46', 35000,  'https://upload.wikimedia.org/wikipedia/fr/thumb/3/38/Universite-Hassan-1er-settat.PNG/330px-Universite-Hassan-1er-settat.PNG'],
  ['UM1',        'Université Mohammed 1er',                  'Oujda',       '#1D4ED8', 50000,  'https://upload.wikimedia.org/wikipedia/commons/6/63/Logo_de_l%27Universit%C3%A9_Mohammed_Premier.svg'],
  ['UCD',        'Université Chouaib Doukkali',              'El Jadida',   '#0891B2', 30000,  'https://upload.wikimedia.org/wikipedia/commons/d/d5/Logo-UCD.jpg'],
  ['USMS',       'Université Sultan Moulay Slimane',         'Béni Mellal', '#7C2D8A', 35000,  'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Usms-logo.png/250px-Usms-logo.png'],
  ['UAQ',        'Université Al Quaraouiyine',               'Fès',         '#92400E', 10000,  'https://upload.wikimedia.org/wikipedia/en/thumb/3/37/University_of_Al_Quaraouiyine_logo.svg/250px-University_of_Al_Quaraouiyine_logo.svg.png'],
  /* ── Grandes Écoles & Instituts ── */
  ['EMI',        'École Mohammadia d\'Ingénieurs',           'Rabat',       '#1E40AF', 3000,   'https://upload.wikimedia.org/wikipedia/fr/thumb/0/05/EMI.PNG/250px-EMI.PNG'],
  ['ENSIAS',     'ENSIAS',                                   'Rabat',       '#4338CA', 1500,   'https://upload.wikimedia.org/wikipedia/commons/1/13/Ensias2.jpg'],
  ['INPT',       'Institut National des P&T',                'Rabat',       '#0F766E', 2000,   'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Logo_inpt.PNG/250px-Logo_inpt.PNG'],
  ['INSEA',      'INSEA',                                    'Rabat',       '#854D0E', 1200,   'https://upload.wikimedia.org/wikipedia/commons/0/05/INSEA_logo.png'],
  ['EHTP',       'École Hassania des Travaux Publics',       'Casablanca',  '#9D174D', 1500,   'https://upload.wikimedia.org/wikipedia/commons/9/91/LogoEHTP.jpg'],
  ['IAV',        'IAV Hassan II',                            'Rabat',       '#166534', 3000,   'https://upload.wikimedia.org/wikipedia/commons/5/54/Logo_iav.png'],
  ['ISCAE',      'ISCAE',                                    'Casablanca',  '#1E3A5F', 4000,   'https://upload.wikimedia.org/wikipedia/commons/e/e3/Logo_groupe_ISCAE.jpg'],
  ['HEM',        'HEM Business School',                      'Casablanca',  '#7E22CE', 8000,   'https://upload.wikimedia.org/wikipedia/commons/7/76/Logo_HEM.svg'],
  ['ENCG-CASA',  'ENCG Casablanca',                          'Casablanca',  '#0E4F8B', 3000,   'https://upload.wikimedia.org/wikipedia/commons/6/60/ENCG-Casablanca.png'],
  ['ENCG-FES',   'ENCG Fès',                                 'Fès',         '#3730A3', 2500,   'https://upload.wikimedia.org/wikipedia/commons/6/60/ENCG-Casablanca.png'],
  /* ── Universités Privées ── */
  ['UIR',        'Université Internationale de Rabat',       'Rabat',       '#0369A1', 8000,   'https://upload.wikimedia.org/wikipedia/commons/4/46/LOGO_UIR.jpg'],
  ['UM6P',       'Université Mohammed VI Polytechnique',     'Ben Guerir',  '#374151', 3000,   'https://upload.wikimedia.org/wikipedia/commons/1/15/UM6P-Universit%C3%A9-Mohamed-VI-polytechnique.png'],
  ['UAA',        'Université Al Akhawayn',                   'Ifrane',      '#B91C1C', 2000,   'https://upload.wikimedia.org/wikipedia/commons/4/49/Al_Akhawayn_logo.jpg'],
  ['UIC',        'Université Internationale de Casablanca',  'Casablanca',  '#0E7490', 5000,   'https://upload.wikimedia.org/wikipedia/commons/8/82/Universit%C3%A9_Internationale_de_Casablanca.jpg'],
  ['UEMF',       'Université Euro-Méditerranéenne de Fès',   'Fès',         '#1A56DB', 3000,   'https://upload.wikimedia.org/wikipedia/commons/f/fd/Logo_Universit%C3%A9_Euromed_de_F%C3%A8s.png'],
  ['UPM',        'Université Privée de Marrakech',           'Marrakech',   '#C2410C', 4000,   'https://upload.wikimedia.org/wikipedia/commons/8/8e/LOGO_UPM_-_UNIVERSITE_PRIVEE_DE_MARRAKECH.jpg'],
  ['MUNDIAPOLIS','Université Mundiapolis',                    'Casablanca',  '#4B5563', 6000,   'https://upload.wikimedia.org/wikipedia/commons/8/8a/Mundiapolislogo.gif'],
];
